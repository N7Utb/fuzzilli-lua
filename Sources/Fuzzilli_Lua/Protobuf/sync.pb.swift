...
public struct Fuzzilli_Protobuf_Statistics {
  ...
  public var foundEdges: UInt64 {
    get {return _storage._foundEdges}
    set {_uniqueStorage()._foundEdges = newValue}
  }
...
extension Fuzzilli_Protobuf_Statistics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _foundEdges = source._foundEdges
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 13: try { try decoder.decodeSingularUInt64Field(value: &_storage._numChildNodes) }()
        case 14: try { try decoder.decodeSingularDoubleField(value: &_storage._coverage) }()
        case 15: try { try decoder.decodeSingularDoubleField(value: &_storage._correctnessRate) }()
        case 16: try { try decoder.decodeSingularDoubleField(value: &_storage._timeoutRate) }()
        case 17: try { try decoder.decodeSingularUInt64Field(value: &_storage._foundEdges) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._numChildNodes != 0 {
        try visitor.visitSingularUInt64Field(value: _storage._numChildNodes, fieldNumber: 13)
      }
      if _storage._coverage != 0 {
        try visitor.visitSingularDoubleField(value: _storage._coverage, fieldNumber: 14)
      }
      if _storage._correctnessRate != 0 {
        try visitor.visitSingularDoubleField(value: _storage._correctnessRate, fieldNumber: 15)
      }
      if _storage._timeoutRate != 0 {
        try visitor.visitSingularDoubleField(value: _storage._timeoutRate, fieldNumber: 16)
      }
      if _storage._foundEdges != 0 {
        try visitor.visitSingularUInt64Field(value: _storage._foundEdges, fieldNumber: 17)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Fuzzilli_Protobuf_Statistics, rhs: Fuzzilli_Protobuf_Statistics) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._foundEdges != rhs_storage._foundEdges {return false}
