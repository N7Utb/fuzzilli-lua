...
public class CodeGenerator: Contributor {
    ...
    fileprivate init(name: String, isValueGenerator: Bool, isRecursive: Bool, inputTypes: [LuaType], context: Context = .script, adapter: GeneratorAdapter) {
        assert(!isValueGenerator || context == .script)
    ...
    public convenience init(_ name: String, inContext context: Context = .script, _ f: @escaping GeneratorFuncNoArgs) {
    ...
    public convenience init(_ name: String, inContext context: Context = .script, input type: LuaType, _ f: @escaping GeneratorFunc1Arg) {
    ...
    public convenience init(_ name: String, inContext context: Context = .script, inputs types: (LuaType, LuaType), _ f: @escaping GeneratorFunc2Args) {
...
public func RecursiveCodeGenerator(_ name: String, inContext context: Context = .script, _ f: @escaping GeneratorFuncNoArgs) -> CodeGenerator {
...
public func RecursiveCodeGenerator(_ name: String, inContext context: Context = .script, input type: LuaType, _ f: @escaping GeneratorFunc1Arg) -> CodeGenerator {
...
public func RecursiveCodeGenerator(_ name: String, inContext context: Context = .script, inputs types: (LuaType, LuaType), _ f: @escaping GeneratorFunc2Args) -> CodeGenerator {
...
public func ValueGenerator(_ name: String, _ f: @escaping ValueGeneratorFunc) -> CodeGenerator {
    return CodeGenerator(name: name, isValueGenerator: true, isRecursive: false, inputTypes: [], context: .script, adapter: ValueGeneratorAdapter(f: f))
}

public func RecursiveValueGenerator(_ name: String, _ f: @escaping ValueGeneratorFunc) -> CodeGenerator {
    return CodeGenerator(name: name, isValueGenerator: true, isRecursive: true, inputTypes: [], context: .script, adapter: ValueGeneratorAdapter(f: f))
}
